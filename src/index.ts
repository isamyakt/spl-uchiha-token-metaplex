...
async function createTokenMetadata(
    ...
    // file to buffer
    const buffer = fs.readFileSync("assets/uchihaclan.png")
  
    // buffer to metaplex file
    const file = toMetaplexFile(buffer, "uchihaclan.png")
...
// All you need to do is change the transaction from 
// createCreateMetadataAccountV2Instruction to createUpdateMetadataAccountV2Instruction
...
async function main() {
    ...
    const MINT_ADDRESS = "FKrjEt74vq4yHEMocfsUbeTjLtnSzpZwBCxJDDEzJqBq"
    ...
    await updateTokenMetadata(
      ...
      user,
      "Uchiha Clan", // Token name - REPLACE THIS WITH YOURS
      "UCHIHA",     // Token symbol - REPLACE THIS WITH YOURS
      "Whoever holds this token is invited to Uchiha Clan party" // Token description - REPLACE THIS WITH YOURS
    )
}
